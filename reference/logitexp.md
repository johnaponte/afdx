...
Fit a logit model of v.density on v.fever v.density with a exponential
coefficient for the v.density
...
This corresponds to the model 3 describe by Smith, T., Schellenberg,
J.A., Hayes, R., 1994. Attributable fraction estimates and case
definitions for malaria in endemic areas. Stat Med 13, 2345–2358.

## See also

[`senspec`](https://johnaponte.github.io/afdx/reference/senspec.md)
